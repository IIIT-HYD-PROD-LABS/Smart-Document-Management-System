...
SYNTHETIC_DATA = {
    "bills": [
        ...
        "dth direct to home satellite television monthly subscription package channels amount statement period due date",
    ...
    "tickets": [
        ...
        "zoo ticket entry visitor adult child camera fee battery vehicle safari guide map schedule timing",
