"""Classifier + resolve_route unit tests (no DB required)."""
from __future__ import annotations

from types import SimpleNamespace

from app.email.services.classifier import (
    ROUTE_BILL,
    ROUTE_COMPLIANCE,
    ROUTE_DMS_ONLY,
    classify,
...
def test_resolve_route_lower_priority_wins():
    ...
    route = resolve_route("a@gst.gov.in", "hello", rules=ordered)
    assert route == ROUTE_BILL
