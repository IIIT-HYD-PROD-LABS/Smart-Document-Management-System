...
- [ ] 15-06-PLAN.md — Wave 3B frontend (typed email-api + 7 components + 6 pages + sidebar nav; reconciliation #3 enforced — js-cookie not localStorage)
...
| 15. Gmail MCP Integration | v2.0 | 3/7 | In Progress|  |
