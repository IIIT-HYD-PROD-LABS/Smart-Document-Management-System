...
- [x] **EMAIL-06**: Automated ComplianceNotice creation when sender/content matches notice patterns; classification confidence ≥0.75 auto-creates with status=Received, below routes to Phase 10 human review queue
...
- [x] **EMAIL-10**: Connection health monitoring — Gmail `invalid_grant` marks credential REVOKED, disables scanner, emits `gmail.connection.lost` event for Phase 11 banner
...
- [x] **BILL-04**: Pre-deadline reminders for bill due dates (T-3, T-1, overdue) — reuses Phase 11 alert pipeline with `BILL_DUE_SOON` event type and per-bill cool-down (max 3 reminders)
...
| Phase 15: Gmail MCP Integration & Email Document Ingestion | EMAIL-01..10, BILL-01..06 | 16 |
| **Total** | | **108** |

---
*Requirements defined: 2026-03-30*
*Last updated: 2026-04-28 — Phase 15 added (EMAIL-01..10 + BILL-01..06); coverage now 108/108 mapped*
